...
function parseArticle(
  ...
  return {
    ...
    ...(data.romanizedTitle ? { romanizedTitle: data.romanizedTitle } : {}),
    ...
    ...(data.coDirector ? { coDirector: data.coDirector } : {}),
    ...(data.writer ? { writer: data.writer } : {}),
    ...(data.writers ? { writers: data.writers } : {}),
    ...(data.screenplay ? { screenplay: data.screenplay } : {}),
    ...(data.basedOn ? { basedOn: data.basedOn } : {}),
